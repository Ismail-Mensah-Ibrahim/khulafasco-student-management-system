...
export default async function AcademicClassesPage() {
  ...
  const teachers = staff.filter((s) => s.is_active && (s.role === "teacher" || s.role === "academic_head" || s.role === "assistant_headmaster" || s.role === "admin" || s.additional_roles?.includes("teacher")));
